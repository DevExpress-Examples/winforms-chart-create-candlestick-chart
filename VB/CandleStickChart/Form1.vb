...
Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
    ...
    ' Add points to it.
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 1), New Object() { 24.00, 25.00, 25.00, 24.875 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 2), New Object() { 23.625, 25.125, 24.00, 24.875 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 3), New Object() { 26.25, 28.25, 26.75, 27.00 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 4), New Object() { 26.50, 27.875, 26.875, 27.25 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 7), New Object() { 26.375, 27.50, 27.375, 26.75 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 8), New Object() { 25.75, 26.875, 26.75, 26.00 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 9), New Object() { 25.75, 26.75, 26.125, 26.25 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 10), New Object() { 25.75, 26.375, 26.375, 25.875 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 11), New Object() { 24.875, 26.125, 26.00, 25.375 }))
    series1.Points.Add(New SeriesPoint(New Date(1994, 3, 14), New Object() { 25.125, 26.00, 25.625, 25.75 }))
